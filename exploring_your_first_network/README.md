...
Resources
Required
What is an IP address? - Introductory explanation of IPv4 and IPv6.
What is DNS? - Introductory explanation of name resolution.
IPv6 Addresses Explained - Introduction to IPv6 and address-space limitations in IPv4.
Linux ip manual page - Reference for interfaces, addresses, routes, and neighbors.
Linux ss manual page - Reference for socket inspection.
Linux ping manual page - Reference for ICMP reachability tests.
Linux getent manual page - Reference for name-service database lookups.
GNU System Databases and Name Service Switch - Context for system hostname resolution and the Name Service Switch.
